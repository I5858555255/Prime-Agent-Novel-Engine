...
- **Devin** (requires OAuth, see below)
- **Amazon Bedrock**
- **OpenCode Zen**
- **OpenCode Go**
...
- Devin (`devin-agent`) is not supported in browser environments.
...
| Devin | `DEVIN_API_KEY` (session token; normally populated through OAuth) |
