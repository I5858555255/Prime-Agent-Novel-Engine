...
**GreenPT**: European AI provider with an OpenAI-compatible API, optimized infrastructure, and data centers powered by 100% renewable energy. Set `GREENPT_API_KEY` and use `glm-5.2` or `kimi-k2.7-code`.
