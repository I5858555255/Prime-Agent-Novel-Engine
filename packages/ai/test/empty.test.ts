...
describe("AI Providers Empty Message Tests", () => {
	...
	describe.skipIf(!process.env.MODEL_API_KEY)("Meta Model API Provider Empty Messages", () => {
	...
	describe.skipIf(!process.env.CELERIS_API_KEY)("Celeris Provider Empty Messages", () => {
