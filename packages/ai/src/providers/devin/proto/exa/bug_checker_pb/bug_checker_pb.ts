 ...
 */
export const file_exa_bug_checker_pb_bug_checker: GenFile =
	/*@__PURE__*/
	fileDesc(
		"",
	);
 ...
 */
export const FixSchema: GenMessage<Fix> = /*@__PURE__*/ messageDesc(file_exa_bug_checker_pb_bug_checker, 0);
 ...
 */
export const BugSchema: GenMessage<Bug> = /*@__PURE__*/ messageDesc(file_exa_bug_checker_pb_bug_checker, 1);
