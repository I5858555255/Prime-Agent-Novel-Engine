...
export const MODELS = {
	...
	"impossibl": {
		"anthropic/claude-fable-5": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":true,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"cacheControlFormat":"anthropic","supportsLongCacheRetention":false},
			reasoning: true,
