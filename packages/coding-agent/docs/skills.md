...
Prime Agent implements the [Agent Skills standard](https://agentskills.io/specification), warning about violations but remaining lenient.
...
- Packages: `skills/` directories or `api.skills` entries in `package.json`
...
1. At startup, Prime Agent scans skill locations and extracts names and descriptions
...
- [Prime Agent Skills](https://github.com/badlogic/pi-skills) - Web search, browser automation, Google APIs, transcription
