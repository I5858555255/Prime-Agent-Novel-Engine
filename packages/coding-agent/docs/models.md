...
| `supportsServerCompaction` | Whether a custom OpenAI Responses endpoint implements `context_management` compaction items. Official OpenAI and Codex endpoints enable this automatically; custom endpoints default to `false`. |
