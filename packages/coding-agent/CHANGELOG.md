...
- Changed OpenAI API-key and Codex subscription sessions to use OpenAI Responses automatic server-side compaction at the normal threshold while retaining local `/compact`, model-requested compaction, and overflow recovery ([#913](https://github.com/PrimeIntellect-ai/prime-agent/pull/913) by [@paulbrav](https://github.com/paulbrav)).
