...
- Added a `/harness` selector and enable/disable controls for continual harness entries, so entries can be retired without deleting them and without adding commands to the conversation.
