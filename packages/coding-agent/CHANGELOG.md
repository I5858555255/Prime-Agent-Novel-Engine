...
- Changed OpenAI API-key and Codex subscription sessions to use server-side compaction for automatic context management while retaining local `/compact` and overflow recovery.
