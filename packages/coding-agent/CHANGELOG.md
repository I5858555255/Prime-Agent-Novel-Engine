...
- Fixed concurrent TypeScript and Python continual-harness writes losing updates or exposing partial JSON ([#929](https://github.com/PrimeIntellect-ai/prime-agent/issues/929)).
