...
- Fixed Python kernel bootstraps changing locked base dependencies across platforms, rebuilds, and skill updates ([#932](https://github.com/PrimeIntellect-ai/prime-agent/issues/932)).
