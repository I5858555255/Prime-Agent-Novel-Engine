...
- Added `"npm": ">=11.10"` to the root `engines` field so the `min-release-age=7` supply-chain cooldown in `.npmrc` is actually enforced ([#874](https://github.com/PrimeIntellect-ai/prime-agent/issues/874)).
