...
- Added `supportsAnthropicFastMode` to the underlying AI SDK to identify models that accept `speed: "fast"` with the Anthropic `fast-mode-2026-02-01` beta ([#867](https://github.com/PrimeIntellect-ai/prime-agent/issues/867)).
