...
- Fixed managed Python kernel bootstraps resolving different base dependency versions across installs ([#932](https://github.com/PrimeIntellect-ai/prime-agent/issues/932))
