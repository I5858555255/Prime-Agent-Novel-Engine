...
- Fixed CLI networking and package-pattern dependencies containing high-severity runtime advisories ([#931](https://github.com/PrimeIntellect-ai/prime-agent/issues/931)).
