...
- Fixed saved-session catalog refreshes repeatedly rebuilding the full agents view and rescanning complete append-only session files ([#944](https://github.com/PrimeIntellect-ai/prime-agent/issues/944)).
