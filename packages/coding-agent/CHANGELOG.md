...
- Changed new-chat guidance to show concise shell, command, file, and shortcut hints, with help placed after the model and effort ([ENG-4489](https://linear.app/primeintellect/issue/ENG-4489/rewire-prime-agent-shortcuts-to-match-claude-code-flow)).
