...
- Fixed RLM hiding authenticated Codex child models, including GPT-5.6 Luna, when discovery returned an empty catalog ([#696](https://github.com/PrimeIntellect-ai/prime-agent/issues/696), [#1011](https://github.com/PrimeIntellect-ai/prime-agent/issues/1011)).
