...
- Changed the agents view to sort sessions within each section by last message time, newest first ([ENG-5126](https://linear.app/primeintellect/issue/ENG-5126/sort-agents-view-sessions-by-last-message-time)).
