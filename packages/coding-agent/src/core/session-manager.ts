...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	tokensBefore: number;
	/** Custom data (e.g., ArtifactIndex, version markers for structured compaction) */
	details?: T;
	/** True if generated by a legacy hook, undefined/false if pi-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	fromId: string;
	summary: string;
	/** Custom data (not sent to LLM) */
	details?: T;
	/** True if generated by a legacy hook, false if pi-generated */
	fromHook?: boolean;
}

/**
 * Custom entry for callers to store typed data in the session.
 * Use customType to identify entries.
 *
 * Purpose: Persist custom state across session reloads.
 *
...
/**
 * Custom message entry for callers to inject messages into LLM context.
 * Use customType to identify entries.
 *
 * Unlike CustomEntry, this DOES participate in LLM context.
 * The content is converted to a user message in buildSessionContext().
 * Use details for custom metadata (not sent to LLM).
 *
...
export class SessionManager {
	...
	/** Append a custom entry as child of current leaf, then advance leaf. Returns entry id. */
	 ...
	 * @param customType Identifier for filtering on reload
	 * @param content Message content (string or TextContent/ImageContent array)
	 * @param display Whether to show in TUI (true = styled display, false = hidden)
	 * @param details Optional custom metadata (not sent to LLM)
	 * @returns Entry id
	 */
