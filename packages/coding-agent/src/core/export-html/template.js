    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="prime-agent-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="prime-agent-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'prime-agent-share:v1:sidebar-width';
