...
| Bash commands | `!command` runs and sends output to LLM, `!!command` runs without sending. Press Ctrl+B while running to detach it. |
...
| Ctrl+B | Background running Bash/IPython work |
