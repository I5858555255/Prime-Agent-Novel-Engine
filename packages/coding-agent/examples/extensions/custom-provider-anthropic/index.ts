 ...
 *   prime-agent -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... prime-agent -e ./packages/coding-agent/examples/extensions/custom-provider
 *
