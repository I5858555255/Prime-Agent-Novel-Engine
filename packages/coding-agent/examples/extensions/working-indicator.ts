 ...
 * working indicator shown while Prime Agent is streaming a response.
 *
 * Usage:
 *   prime-agent --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore the default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "prime-agent";
