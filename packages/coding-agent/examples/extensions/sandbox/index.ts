 ...
 *
 * Usage:
 * - `prime-agent -e ./sandbox` - sandbox enabled with default/config settings
 * - `prime-agent -e ./sandbox --no-sandbox` - disable sandboxing
...
import { type BashOperations, createBashTool, getAgentDir } from "prime-agent";
