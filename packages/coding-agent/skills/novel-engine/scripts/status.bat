...
echo.
echo [Commands]
echo   scripts\generate.bat          - Run generation
echo   scripts\start_dashboard.bat   - Start web dashboard
echo   scripts\status.bat chapters   - List chapters
echo   scripts\status.bat clean      - Clean runtime data
echo.
pause