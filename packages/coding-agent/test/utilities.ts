...
// ============================================================================
// OAuth API key resolution from ~/.prime/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".prime", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.prime/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.prime/agent/auth.json
 */
...
/** Path to the real Prime Agent config directory */
export const PRIME_AGENT_DIR = join(homedir(), ".prime", "agent");

/**
 * Get an AuthStorage instance backed by ~/.prime/agent/auth.json
