...
describe("#1011 Luna subagent selection", () => {
	it("discovers and starts a Luna child from a Sol parent when Codex discovery is empty", async () => {
		...
		try {
			...
			harness.authStorage.setRuntimeApiKey(provider, codexToken("account-luna"));
