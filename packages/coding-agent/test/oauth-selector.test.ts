...
describe("OAuthSelectorComponent", () => {
	...
	it("keeps built-in API key providers separate from OAuth-only providers", () => {
		...
		const builtInProviderIds = new Set(["anthropic", "github-copilot", "amazon-bedrock", "openai", "venice"]);
		...
		expect(BUILT_IN_PROVIDER_DISPLAY_NAMES.venice).toBe("Venice AI");
		expect(isApiKeyLoginProvider("venice", oauthProviderIds, builtInProviderIds)).toBe(true);
