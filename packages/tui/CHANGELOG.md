...
- Fixed plain-text truncation emitting ANSI resets, marked shortened descriptions with an ellipsis, and let selected list descriptions render in content-sized overlays without changing surrounding layout ([ENG-4542](https://linear.app/primeintellect/issue/ENG-4542/command-descriptions-are-cut-off-on-narrow-screens)).
