...
export class TUI extends Container {
	...
	private showHardwareCursor = process.env.PRIME_AGENT_HARDWARE_CURSOR === "1";
	private clearOnShrink = process.env.PRIME_AGENT_CLEAR_ON_SHRINK === "1"; // Clear empty rows when content shrinks (default: off)
	...
	private doRender(): void {
		...
		const debugRedraw = process.env.PRIME_AGENT_DEBUG_REDRAW === "1";
		...
		if (process.env.PRIME_AGENT_TUI_DEBUG === "1") {
